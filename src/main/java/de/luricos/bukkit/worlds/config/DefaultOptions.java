 ...
 */
package de.luricos.bukkit.worlds.config;

import de.luricos.bukkit.worlds.config.ConfigManager.ServerOptionKeys;
...
class DefaultOptions {
    ...
    final static ServerOption[] defaultServerOptions = {
        ...
        new ServerOption(ServerOptionKeys.serverOptionTimelock, "Option: Enable or disable timelock functionality. Default: true (enabled)", "boolean", true),
